...
//    }
    private URI createTranslationURI(String query) throws URISyntaxException {
        URIBuilder builder = new URIBuilder();
        builder.setScheme("http").setHost("fanyi.youdao.com").setPath("/openapi.do").addParameter("keyfrom", "Skykai521").addParameter("key", "977124034").addParameter("type", "data").addParameter("version", "1.1").addParameter("doctype", "json").addParameter("callback", "show").addParameter("q", query);
        return builder.build();
    }
